...
import {SWAP_EVENT, UNISWAP_V3_FACTORY_CONTRACT_ADDRESS, UNISWAP_POOL_CONTRACT_CREAT_CODE_HASH, POOL_ABI} from "./constants"
...
function getPoolAddress(token0 : string, token1 : string, fee: string) {   
    ...
    let hash : string = ethers.utils.getCreate2Address(UNISWAP_V3_FACTORY_CONTRACT_ADDRESS, salt, UNISWAP_POOL_CONTRACT_CREAT_CODE_HASH);  
    return hash;
}
